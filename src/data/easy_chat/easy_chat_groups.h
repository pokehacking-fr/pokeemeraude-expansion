...
const struct EasyChatGroup gEasyChatGroups[EC_NUM_GROUPS] = {
    ...
    [EC_GROUP_GREETINGS] =
    {
        .name = COMPOUND_STRING("POLITESSES"),
    ...
    [EC_GROUP_PEOPLE] =
    {
        .name = COMPOUND_STRING("PERSONNES"),
    ...
    [EC_GROUP_VOICES] =
    {
        .name = COMPOUND_STRING("REACTIONS"),
    ...
    [EC_GROUP_LIFESTYLE] =
    {
        .name = COMPOUND_STRING("VIE QUOTIDIEN."),
    ...
    [EC_GROUP_TIME] =
    {
        .name = COMPOUND_STRING("TEMPORALITE"),
    ...
    [EC_GROUP_ADJECTIVES] =
    {
        .name = COMPOUND_STRING("QUALIFICATIFS"),
    ...
    [EC_GROUP_EVENTS] =
    {
        .name = COMPOUND_STRING("EVENEMENTS"),
    ...
    [EC_GROUP_MOVE_1] =
    {
        .name = COMPOUND_STRING("CAPACITE 1"),
    ...
    [EC_GROUP_MOVE_2] =
    {
        .name = COMPOUND_STRING("CAPACITE 2"),
    ...
    {
        .name = COMPOUND_STRING("MOTS COOL"),
