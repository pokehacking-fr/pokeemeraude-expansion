...
{
    const struct BerryInfo *berryInfo = GetBerryInfo(sBerryTag->berryId);
    AddTextPrinterParameterized(WIN_DESC, FONT_NORMAL, berryInfo->description1, 5, 1, 0, NULL); //!< French Difference
}

static void PrintBerryDescription2(void)
{
    const struct BerryInfo *berryInfo = GetBerryInfo(sBerryTag->berryId);
    AddTextPrinterParameterized(WIN_DESC, FONT_NORMAL, berryInfo->description2, 5, 0x11, 0, NULL); //!< French Difference
}
