...
static const u8 sText_LinkTrainerIntroSendOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} envoie {B_LINK_OPPONENT_MON1_NAME}!");
...
static const u8 sText_WildPkmnPrefixLower[] = _(" sauvage");
static const u8 sText_FoePkmnPrefixLower[] = _(" ennemi");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_STATROSE]                             = COMPOUND_STRING("Ah, {B_BUFF1} du {B_ATK_NAME_WITH_PREFIX} monte{B_BUFF2}!"),
    [STRINGID_STATFELL]                             = COMPOUND_STRING("Ah, {B_BUFF1} du {B_ATK_NAME_WITH_PREFIX} baisse{B_BUFF2}!"),
    ...
    [STRINGID_SCRCUREDPARALYSIS]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} est soigné de sa paralysie!"),
    [STRINGID_SCRCUREDPOISON]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} n'es plus empoisonné!"),
    [STRINGID_SCRCUREDBURN]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} a soigné sa brûlure!"),
    [STRINGID_SCRCUREDSLEEP]                        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} s'es réveillé!"),
    [STRINGID_SCRCUREDCONFUSION]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} est sorti de sa confisuion!"),
    [STRINGID_PARTYCUREDPARALYSIS]                  = COMPOUND_STRING("{B_BUFF1} est soigné de sa paralysie!"),
    [STRINGID_PARTYCUREDPOISON]                     = COMPOUND_STRING("{B_BUFF1} n'es plus empoisonné!"),
    [STRINGID_PARTYCUREDBURN]                       = COMPOUND_STRING("{B_BUFF1} a soigné sa brûlure!"),
    [STRINGID_PARTYCUREDSLEEP]                      = COMPOUND_STRING("{B_BUFF1} s'es réveillé!"),
    [STRINGID_PARTYCUREDFREEZE]                     = COMPOUND_STRING("{B_BUFF1} a dégongelé!"),
    [STRINGID_PARTYCUREDFROSTBITE]                  = COMPOUND_STRING("{B_BUFF1} a guéri de son engelure!"),
    [STRINGID_PKMNATKNOTLOWERED]                    = COMPOUND_STRING("l'Attaque {B_SCR_NAME_WITH_PREFIX} n'a pas été baissée!"),
    [STRINGID_REFLECTWOREOFF]                       = COMPOUND_STRING("Protection de l'équipe {B_DEF_TEAM1} s'estompe!"),
    [STRINGID_LIGHTSCREENWOREOFF]                   = COMPOUND_STRING("Mur lumière de l'équipe {B_DEF_TEAM1} s'estompe!"),
    [STRINGID_AURORAVEILWOREOFF]                    = COMPOUND_STRING("Voile Aurore de l'équipe {B_DEF_TEAM1} s'estompe!"),
