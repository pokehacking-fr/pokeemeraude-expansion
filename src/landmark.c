...
static const u8 LandmarkName_MagmaHideout[] = _("PLANQUE MAGMA"); //Unused

static const struct Landmark Landmark_FlowerShop = {COMPOUND_STRING("FLEURISTE"), FLAG_LANDMARK_FLOWER_SHOP};
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("BOIS CLEMENTI"), -1};
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("COTTAGE DE M. MARCO"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("EPAVE"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("MAISON DU BORD DE MER"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("PLAGE POIVRESSEL"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("PISTE CYCLABLE"), -1};
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("NEW LAVANDIA"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("MAISON DES PIEGES"), FLAG_LANDMARK_TRICK_HOUSE};
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("GITE VIEILLE DAME"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("DESERT"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("FAMILLE STRATEGE"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("TELEPHERIQUE"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("ATELIER DU VERRE"), FLAG_LANDMARK_GLASS_WORKSHOP};
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("CENTRE METEO"), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("SITE METEORE"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("REFUGE DES FOREURS"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("TUNNEL MERAZON"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("PENSION POKéMON"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("ENTREE PARC SAFARI"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("MONT MEMORIA"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("GROTTE TREFONDS"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("CAVERNE FONDMER"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("GROTTE GRANITE"), -1};
static const struct Landmark Landmark_OceanCurrent = {COMPOUND_STRING("COURANT OCEANIQUE"), -1};
static const struct Landmark Landmark_LanettesHouse = {COMPOUND_STRING("MAISON D'ANNETTE"), FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("CHEMIN ARDENT"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("SENTIER SINUROC"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("PILIER CELESTE"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("MAITRE DES BAIES"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("GROTTE ISLAND"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("RUINES DESERT"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("GROTTE ZENITH"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("TOMBEAU ANTIQUE"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("SANCTUAIRE"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("MANIAQUE DES FOSSILES"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("CHERCHEUR DE TRESORS"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("TOUR MIRAGE"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("GROTTE METAMO"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("VOIE DU DESERT"), FLAG_LANDMARK_DESERT_UNDERPASS};
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("MONT DRESSEURS"), FLAG_LANDMARK_TRAINER_HILL};
